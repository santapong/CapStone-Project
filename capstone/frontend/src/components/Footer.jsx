...
function Footer() {
  ...
  <nav>
    ...
    <a className="link link-hover" href="https://opentyphoon.ai/">Typhoon ai</a>
    <h6 className="footer-title">Github</h6>
    <a className="link link-hover" href='https://github.com/santapong/CapStone-Project'>Capstone Repository</a>
  </nav>
</footer>
</>
  )
